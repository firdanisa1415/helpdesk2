  ...
  <div>
    ...
    <div class="overflow-x-auto relative sm:rounded-lg">
        ...
        <modal :show="detailPelaporan">
          ...
          <template #body>
                ...
                <div class="flex flex-wrap">
                  <div class="lg:w-3/12 ">
                    <div class="relative w-full mb-3">
                      <h2 class="block uppercase text-blueGray-600 text-xs font-bold mb-2">Jenis Product</h2>
                    </div>
                  </div>
                  <div class="lg:w-9/12">
                    <div class="relative w-full mb-3">
      ...
      <table class="w-full mb-5 overflow-x-auto relative">
        ...
        <tbody>
          <tr v-for="item in reports" :key="item.id_pelaporan" class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
